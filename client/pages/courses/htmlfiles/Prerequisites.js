...
const Prerequisites = () => {
    ...
    useEffect(() => {
        document.title = 'Prerequisites - HTML/Tutorial'
    }, [])
                ...
                <div className='content-toggle'>
                    ...
                    <div className="content">
                        <div className="text-2xl font-bold">
                            <span className='text-2xl text-green-300 cursor-pointer'>#</span> HTML Prerequisites
                        </div><div className="coming-soon text-xl font-bold mt-5 ml-4">
                            Coming Soon...
                        </div>
